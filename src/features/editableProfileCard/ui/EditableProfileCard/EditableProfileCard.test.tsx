...
describe('features/EditableProfileCard', () => {
  test('readonly true', async () => {
    ...
    await userEvent.click(
      await screen.getByTestId('EditableProfileCardHeader.EditButton'),
    );
    expect(
  ...
  test('Должна появиться ошибка', async () => {
    ...
    await userEvent.click(
      await screen.getByTestId('EditableProfileCardHeader.SaveButton'),
    );

    expect(
      await screen.getByTestId('EditableProfileCard.Error.Paragraph'),
    ).toBeInTheDocument();
  });
